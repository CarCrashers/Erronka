      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content p-4 rounded-4 shadow-lg border-0">
          ...
          <div className="text-center mb-4">
            <img src={Logo} alt="CarCrashers Logo" className="mb-3 rounded-circle" style={{ width: '80px', height: '80px', objectFit: 'cover' }} />
          ...
          <form>
            <div className="mb-3">
              ...
              <div className="input-group">
                ...
                <input type="email" className="form-control bg-light border-start-0 ps-0" placeholder="juan@adibidea.com" />
              </div>
            </div>
            ...
            <div className="mb-3">
              ...
              <div className="input-group">
                ...
                <input type="password" className="form-control bg-light border-start-0 ps-0" placeholder="••••••••" />
              </div>
            </div>

            <button type="submit" className="btn btn-dark w-100 py-2 mt-3 rounded-3" style={{ backgroundColor: '#111827' }}>Sign in</button>
          </form>
